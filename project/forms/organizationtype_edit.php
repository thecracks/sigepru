...
require(__PANEL__ . '/OrganizationtypeEditPanel.class.php');
 ...
 * OrganizationtypeConnector class, which has methods to help with
 * easily creating/defining controls to modify the fields of Organizationtype columns.
 *
 ...
 * @subpackage Drafts
 */
class OrganizationtypeEditForm extends QForm {

	/** @var OrganizationtypeEditPanel  */
	protected $pnlOrganizationtype;
...
//	protected function Form_Load() {}
	...
	protected function Form_Create() {
        ...
        $this->strObjectName = QApplication::Translate('Organizationtype');
        $this->strObjectNamePlural = QApplication::Translate('Organizationtypes');

        $this->pnlOrganizationtype = new OrganizationtypeEditPanel($this);
		$intIdOrganizationType = QApplication::QueryString('intIdOrganizationType');
	    $this->pnlOrganizationtype->Load($intIdOrganizationType);
		$this->CreateButtons();
	}
	...
	protected function CreateButtons() {
		...
		$this->btnDelete->Visible = $this->pnlOrganizationtype->mctOrganizationtype->EditMode;
	}
    ...
    */
    protected function dlgOptimisticLocking_ButtonEvent($strFormId, $strControlId, $btn) {
        if ($btn == "Overwrite") {
            $this->pnlOrganizationtype->Save(true);
            $this->GetControl($strControlId)->Close();
            $this->RedirectToListPage();
        } else { // Refresh
            $this->GetControl($strControlId)->Close();
            $this->pnlOrganizationtype->Refresh(true);
        }
    }
    ...
    */
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		$this->pnlOrganizationtype->Delete();
		$this->RedirectToListPage();
	}
    ...
    */
	protected function RedirectToListPage() {
		QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORMS__ . '/organizationtype_list.php',
...
// organizationtype_edit.tpl.php as the included HTML template file
OrganizationtypeEditForm::Run('OrganizationtypeEditForm');
