...
require(__PANEL__ . '/EvaluacionEditPanel.class.php');

/**
 * This is a draft QForm object to do Create, Edit, and Delete functionality
 * of the Evaluacion class.  It uses the code-generated
 * EvaluacionConnector class, which has methods to help with
 * easily creating/defining controls to modify the fields of Evaluacion columns.
 *
 ...
 * @subpackage Drafts
 */
class EvaluacionEditForm extends QForm {

	/** @var EvaluacionEditPanel  */
	protected $pnlEvaluacion;
...
//	protected function Form_Load() {}
	...
	protected function Form_Create() {
        ...
        $this->strObjectName = QApplication::Translate('Evaluacion');
        $this->strObjectNamePlural = QApplication::Translate('Evaluacions');

        $this->pnlEvaluacion = new EvaluacionEditPanel($this);
		$strEvaluacionId = QApplication::QueryString('strEvaluacionId');
	    $this->pnlEvaluacion->Load($strEvaluacionId);
		$this->CreateButtons();
	}
	...
	protected function CreateButtons() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Evaluacion'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->pnlEvaluacion->mctEvaluacion->EditMode;
	}
    ...
    */
    protected function dlgOptimisticLocking_ButtonEvent($strFormId, $strControlId, $btn) {
        if ($btn == "Overwrite") {
            $this->pnlEvaluacion->Save(true);
            $this->GetControl($strControlId)->Close();
            $this->RedirectToListPage();
        } else { // Refresh
            $this->GetControl($strControlId)->Close();
            $this->pnlEvaluacion->Refresh(true);
        }
    }
    ...
    */
	protected function RedirectToListPage() {
		QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORMS__ . '/evaluacion_list.php',
...
// evaluacion_edit.tpl.php as the included HTML template file
EvaluacionEditForm::Run('EvaluacionEditForm');
