...
require(__PANEL__ . '/NivelEditPanel.class.php');

/**
 * This is a draft QForm object to do Create, Edit, and Delete functionality
 * of the Nivel class.  It uses the code-generated
 * NivelConnector class, which has methods to help with
 * easily creating/defining controls to modify the fields of Nivel columns.
 *
 ...
 * @subpackage Drafts
 */
class NivelEditForm extends QForm {
...
//	protected function Form_Load() {}
	...
	protected function Form_Create() {
        ...
        $this->pnlNivel = new NivelEditPanel($this);
		$strNivelId = QApplication::QueryString('strNivelId');
	    $this->pnlNivel->Load($strNivelId);
		$this->CreateButtons();
	}
	...
	protected function CreateButtons() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Nivel'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->pnlNivel->mctNivel->EditMode;
	}
    ...
    */
    protected function dlgOptimisticLocking_ButtonEvent($strFormId, $strControlId, $btn) {
        if ($btn == "Overwrite") {
            $this->pnlNivel->Save(true);
            $this->GetControl($strControlId)->Close();
            $this->RedirectToListPage();
        } else { // Refresh
            $this->GetControl($strControlId)->Close();
            $this->pnlNivel->Refresh(true);
        }
    }
    ...
    */
	protected function RedirectToListPage() {
		QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORMS__ . '/nivel_list.php',
...
// nivel_edit.tpl.php as the included HTML template file
NivelEditForm::Run('NivelEditForm');
