...
require(__PANEL__ . '/AdministratorEditPanel.class.php');
 ...
 * AdministratorConnector class, which has methods to help with
 * easily creating/defining controls to modify the fields of Administrator columns.
 *
 ...
 * @subpackage Drafts
 */
class AdministratorEditForm extends QForm {
...
//	protected function Form_Load() {}
	...
	protected function Form_Create() {
        ...
        $this->strObjectName = QApplication::Translate('Administrator');
        $this->strObjectNamePlural = QApplication::Translate('Administrators');
	...
	protected function CreateButtons() {
		...
		$this->btnDelete->Visible = $this->pnlAdministrator->mctAdministrator->EditMode;
	}
    ...
    */
	protected function RedirectToListPage() {
		QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORMS__ . '/administrator_list.php',
