<?php
	...
	require(__PANEL__ . '/OrganizationtypeListPanel.class.php');

	/**
	 * This is a draft QForm object to do the List All functionality
	 * of the Organizationtype class, and is a starting point for the form object.
	 *
	 ...
	 */
	class OrganizationtypeListForm extends QForm {
        /** @var NavPanel */
		protected $pnlNav;
        /** @var OrganizationtypeListPanel */
		protected $pnlOrganizationtypeList;
        /** @var string */
		...
		protected function Form_Create() {
			...
			$this->pnlOrganizationtypeList = new OrganizationtypeListPanel($this);
		}
