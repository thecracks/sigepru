...
require(__PANEL__ . '/AlternativaEditPanel.class.php');

/**
 * This is a draft QForm object to do Create, Edit, and Delete functionality
 * of the Alternativa class.  It uses the code-generated
 * AlternativaConnector class, which has methods to help with
 * easily creating/defining controls to modify the fields of Alternativa columns.
 *
 ...
 * @subpackage Drafts
 */
class AlternativaEditForm extends QForm {

	/** @var AlternativaEditPanel  */
	protected $pnlAlternativa;
...
//	protected function Form_Load() {}
	...
	protected function Form_Create() {
        ...
        $this->pnlAlternativa = new AlternativaEditPanel($this);
		$strAlternativaId = QApplication::QueryString('strAlternativaId');
	    $this->pnlAlternativa->Load($strAlternativaId);
		$this->CreateButtons();
	}
	...
	protected function CreateButtons() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Alternativa'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->pnlAlternativa->mctAlternativa->EditMode;
	}
    ...
    */
    protected function dlgOptimisticLocking_ButtonEvent($strFormId, $strControlId, $btn) {
        if ($btn == "Overwrite") {
            $this->pnlAlternativa->Save(true);
            $this->GetControl($strControlId)->Close();
            $this->RedirectToListPage();
        } else { // Refresh
            $this->GetControl($strControlId)->Close();
            $this->pnlAlternativa->Refresh(true);
        }
    }
    ...
    */
	protected function RedirectToListPage() {
		QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORMS__ . '/alternativa_list.php',
...
// alternativa_edit.tpl.php as the included HTML template file
AlternativaEditForm::Run('AlternativaEditForm');
