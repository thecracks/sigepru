...
require(__PANEL__ . '/GradoEditPanel.class.php');

/**
 * This is a draft QForm object to do Create, Edit, and Delete functionality
 * of the Grado class.  It uses the code-generated
 * GradoConnector class, which has methods to help with
 * easily creating/defining controls to modify the fields of Grado columns.
 *
 ...
 * @subpackage Drafts
 */
class GradoEditForm extends QForm {
...
//	protected function Form_Load() {}
	...
	protected function CreateButtons() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Grado'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->pnlGrado->mctGrado->EditMode;
	}
    ...
    */
	protected function RedirectToListPage() {
		QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORMS__ . '/grado_list.php',
...
// grado_edit.tpl.php as the included HTML template file
GradoEditForm::Run('GradoEditForm');
