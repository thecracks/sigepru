...
require(__PANEL__ . '/ListaCursoEditPanel.class.php');

/**
 * This is a draft QForm object to do Create, Edit, and Delete functionality
 * of the ListaCurso class.  It uses the code-generated
 * ListaCursoConnector class, which has methods to help with
 * easily creating/defining controls to modify the fields of ListaCurso columns.
 *
 ...
 * @subpackage Drafts
 */
class ListaCursoEditForm extends QForm {
...
//	protected function Form_Load() {}
	...
	protected function Form_Create() {
        ...
        $this->strObjectName = QApplication::Translate('ListaCurso');
        $this->strObjectNamePlural = QApplication::Translate('ListaCursos');
	...
	protected function CreateButtons() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('ListaCurso'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->pnlListaCurso->mctListaCurso->EditMode;
	}
    ...
    */
	protected function RedirectToListPage() {
		QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORMS__ . '/lista_curso_list.php',
...
// lista_curso_edit.tpl.php as the included HTML template file
ListaCursoEditForm::Run('ListaCursoEditForm');
