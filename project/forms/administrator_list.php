<?php
	...
	require(__PANEL__ . '/AdministratorListPanel.class.php');

	/**
	 * This is a draft QForm object to do the List All functionality
	 * of the Administrator class, and is a starting point for the form object.
	 *
	 ...
	 */
	class AdministratorListForm extends QForm {
        /** @var NavPanel */
		protected $pnlNav;
        /** @var AdministratorListPanel */
		protected $pnlAdministratorList;
        /** @var string */
		...
		protected function Form_Create() {
			...
			$this->pnlAdministratorList = new AdministratorListPanel($this);
		}
