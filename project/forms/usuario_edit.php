...
require(__PANEL__ . '/UsuarioEditPanel.class.php');

/**
 * This is a draft QForm object to do Create, Edit, and Delete functionality
 * of the Usuario class.  It uses the code-generated
 * UsuarioConnector class, which has methods to help with
 * easily creating/defining controls to modify the fields of Usuario columns.
 *
 ...
 * @subpackage Drafts
 */
class UsuarioEditForm extends QForm {
...
//	protected function Form_Load() {}
	...
	protected function CreateButtons() {
		...
		$this->btnDelete->Visible = $this->pnlUsuario->mctUsuario->EditMode;
	}
    ...
    */
	protected function RedirectToListPage() {
		QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORMS__ . '/usuario_list.php',
