<?php
	...
	require(__PANEL__ . '/RestaurantListPanel.class.php');

	/**
	 * This is a draft QForm object to do the List All functionality
	 * of the Restaurant class, and is a starting point for the form object.
	 *
	 ...
	 */
	class RestaurantListForm extends QForm {
        /** @var NavPanel */
		protected $pnlNav;
        /** @var RestaurantListPanel */
		protected $pnlRestaurantList;
        /** @var string */
		...
		protected function Form_Create() {
			...
			$this->pnlRestaurantList = new RestaurantListPanel($this);
		}
