...
require(__PANEL__ . '/OfferEditPanel.class.php');

/**
 * This is a draft QForm object to do Create, Edit, and Delete functionality
 * of the Offer class.  It uses the code-generated
 * OfferConnector class, which has methods to help with
 * easily creating/defining controls to modify the fields of Offer columns.
 *
...
//	protected function Form_Load() {}
	...
	protected function Form_Create() {
        ...
        $this->strObjectName = QApplication::Translate('Offer');
        $this->strObjectNamePlural = QApplication::Translate('Offers');

        $this->pnlOffer = new OfferEditPanel($this);
		$intIdOffer = QApplication::QueryString('intIdOffer');
	    $this->pnlOffer->Load($intIdOffer);
		$this->CreateButtons();
	}
	...
	protected function CreateButtons() {
		...
		$this->btnDelete->Visible = $this->pnlOffer->mctOffer->EditMode;
	}
    ...
    */
    protected function dlgOptimisticLocking_ButtonEvent($strFormId, $strControlId, $btn) {
        if ($btn == "Overwrite") {
            $this->pnlOffer->Save(true);
            $this->GetControl($strControlId)->Close();
            $this->RedirectToListPage();
        } else { // Refresh
            $this->GetControl($strControlId)->Close();
            $this->pnlOffer->Refresh(true);
        }
    }
    ...
    */
	protected function RedirectToListPage() {
		QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORMS__ . '/offer_list.php',
