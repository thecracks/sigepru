...
require(__PANEL__ . '/PreguntaEditPanel.class.php');

/**
 * This is a draft QForm object to do Create, Edit, and Delete functionality
 * of the Pregunta class.  It uses the code-generated
 * PreguntaConnector class, which has methods to help with
 * easily creating/defining controls to modify the fields of Pregunta columns.
 *
 ...
 * @subpackage Drafts
 */
class PreguntaEditForm extends QForm {

	/** @var PreguntaEditPanel  */
	protected $pnlPregunta;
...
//	protected function Form_Load() {}
	...
	protected function Form_Create() {
        ...
        $this->strObjectName = QApplication::Translate('Pregunta');
        $this->strObjectNamePlural = QApplication::Translate('Preguntas');

        $this->pnlPregunta = new PreguntaEditPanel($this);
		$strPreguntaId = QApplication::QueryString('strPreguntaId');
	    $this->pnlPregunta->Load($strPreguntaId);
		$this->CreateButtons();
	}
	...
	protected function CreateButtons() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Pregunta'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->pnlPregunta->mctPregunta->EditMode;
	}
    ...
    */
    protected function dlgOptimisticLocking_ButtonEvent($strFormId, $strControlId, $btn) {
        if ($btn == "Overwrite") {
            $this->pnlPregunta->Save(true);
            $this->GetControl($strControlId)->Close();
            $this->RedirectToListPage();
        } else { // Refresh
            $this->GetControl($strControlId)->Close();
            $this->pnlPregunta->Refresh(true);
        }
    }
    ...
    */
	protected function RedirectToListPage() {
		QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORMS__ . '/pregunta_list.php',
...
// pregunta_edit.tpl.php as the included HTML template file
PreguntaEditForm::Run('PreguntaEditForm');
