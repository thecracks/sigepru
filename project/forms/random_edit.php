...
require(__PANEL__ . '/RandomEditPanel.class.php');

/**
 * This is a draft QForm object to do Create, Edit, and Delete functionality
 * of the Random class.  It uses the code-generated
 * RandomConnector class, which has methods to help with
 * easily creating/defining controls to modify the fields of Random columns.
 *
 ...
 * @subpackage Drafts
 */
class RandomEditForm extends QForm {
...
//	protected function Form_Load() {}
	...
	protected function CreateButtons() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Random'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->pnlRandom->mctRandom->EditMode;
	}
    ...
    */
	protected function RedirectToListPage() {
		QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORMS__ . '/random_list.php',
...
// random_edit.tpl.php as the included HTML template file
RandomEditForm::Run('RandomEditForm');
