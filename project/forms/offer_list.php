<?php
	...
	require(__PANEL__ . '/OfferListPanel.class.php');

	/**
	 * This is a draft QForm object to do the List All functionality
	 * of the Offer class, and is a starting point for the form object.
	 *
	...
	class OfferListForm extends QForm {
		...
		protected function Form_Create() {
			...
			$this->pnlOfferList = new OfferListPanel($this);
		}
