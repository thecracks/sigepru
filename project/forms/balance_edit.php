...
require(__PANEL__ . '/BalanceEditPanel.class.php');

/**
 * This is a draft QForm object to do Create, Edit, and Delete functionality
 * of the Balance class.  It uses the code-generated
 * BalanceConnector class, which has methods to help with
 * easily creating/defining controls to modify the fields of Balance columns.
 *
 ...
 * @subpackage Drafts
 */
class BalanceEditForm extends QForm {
...
//	protected function Form_Load() {}
	...
	protected function CreateButtons() {
		...
		$this->btnDelete->Visible = $this->pnlBalance->mctBalance->EditMode;
	}
    ...
    */
	protected function RedirectToListPage() {
		QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORMS__ . '/balance_list.php',
