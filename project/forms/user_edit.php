...
require(__PANEL__ . '/UserEditPanel.class.php');
...
//	protected function Form_Load() {}
	...
	protected function Form_Create() {
        ...
        $this->strObjectName = QApplication::Translate('User');
        $this->strObjectNamePlural = QApplication::Translate('Users');
    ...
    */
	protected function RedirectToListPage() {
		QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORMS__ . '/user_list.php',
