<?php
	...
	require(__PANEL__ . '/CursoListPanel.class.php');

	/**
	 * This is a draft QForm object to do the List All functionality
	 * of the Curso class, and is a starting point for the form object.
	 *
	 ...
	 */
	class CursoListForm extends QForm {
        /** @var NavPanel */
		protected $pnlNav;
        /** @var CursoListPanel */
		protected $pnlCursoList;
        /** @var string */
		...
		protected function Form_Create() {
			...
			$this->pnlCursoList = new CursoListPanel($this);
		}
	...
	// curso_list.tpl.php as the included HTML template file
	CursoListForm::Run('CursoListForm');