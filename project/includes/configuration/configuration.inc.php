...
if (!defined('SERVER_INSTANCE')) {
    ...
    define('__SUBDIRECTORY__', '/prueba1');
    ...
    //DEFINIENDO RUTAS NECESARIAS

    define('__APP_CSS__', __SUBDIRECTORY__ . '/project/bundle/blue/assets/css');
    define('__APP_FONTS__', __SUBDIRECTORY__ . '/project/bundle/blue/assets/fonts');
    define('__APP_IMAGES__', __SUBDIRECTORY__ . '/project/bundle/blue/assets/images');
    define('__APP_JS__', __SUBDIRECTORY__ . '/project/bundle/blue/assets/js');
    define('__APP_PAGES__', __SUBDIRECTORY__ . '/project/bundle/blue/assets/pages');

    define('__APP_PLUGINS__', __SUBDIRECTORY__ . '/project/bundle/plugins');

    define('__MAIN_PATH__',__SUBDIRECTORY__ . '/project');
