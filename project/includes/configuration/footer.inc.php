...
<!--        <script src="<?= __APP_JS__ ?>/jquery.min.js"></script>-->
        <script src="<?= __APP_JS__ ?>/popper.min.js"></script>
        <script src="<?= __APP_JS__ ?>/bootstrap.min.js"></script>
        <script src="<?= __APP_JS__ ?>/detect.js"></script>
        <script src="<?= __APP_JS__ ?>/fastclick.js"></script>
        <script src="<?= __APP_JS__ ?>/jquery.slimscroll.js"></script>
        <script src="<?= __APP_JS__ ?>/jquery.blockUI.js"></script>
        <script src="<?= __APP_JS__ ?>/waves.js"></script>
        <script src="<?= __APP_JS__ ?>/wow.min.js"></script>
        <script src="<?= __APP_JS__ ?>/jquery.nicescroll.js"></script>
        <script src="<?= __APP_JS__ ?>/jquery.scrollTo.min.js"></script>
        <script src="<?= __APP_PLUGINS__ ?>/switchery/switchery.min.js"></script>
