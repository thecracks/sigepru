...
require(__DIALOG_GEN__ . '/DocenteEditDlgGen.class.php');

/**
 * This is the customizable subclass for the edit dialog. This dialog is just a shell for the
 * DocenteEditPanel class, and so you will not likely need to do major customizations here.
 ...
 *
 */
class DocenteEditDlg extends DocenteEditDlgGen {
	...
	public function __construct($objParent = null, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the DocenteEditPanel panel that is
