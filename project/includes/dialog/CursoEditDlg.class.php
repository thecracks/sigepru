...
require(__DIALOG_GEN__ . '/CursoEditDlgGen.class.php');

/**
 * This is the customizable subclass for the edit dialog. This dialog is just a shell for the
 * CursoEditPanel class, and so you will not likely need to do major customizations here.
 ...
 *
 */
class CursoEditDlg extends CursoEditDlgGen {
	...
	public function __construct($objParent = null, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the CursoEditPanel panel that is
