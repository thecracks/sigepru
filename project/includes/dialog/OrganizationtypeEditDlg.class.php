...
require(__DIALOG_GEN__ . '/OrganizationtypeEditDlgGen.class.php');

/**
 * This is the customizable subclass for the edit dialog. This dialog is just a shell for the
 * OrganizationtypeEditPanel class, and so you will not likely need to do major customizations here.
 ...
 *
 */
class OrganizationtypeEditDlg extends OrganizationtypeEditDlgGen {
	...
	public function __construct($objParent = null, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the OrganizationtypeEditPanel panel that is
