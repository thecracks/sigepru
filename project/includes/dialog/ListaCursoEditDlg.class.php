...
require(__DIALOG_GEN__ . '/ListaCursoEditDlgGen.class.php');

/**
 * This is the customizable subclass for the edit dialog. This dialog is just a shell for the
 * ListaCursoEditPanel class, and so you will not likely need to do major customizations here.
 ...
 *
 */
class ListaCursoEditDlg extends ListaCursoEditDlgGen {
	...
	public function __construct($objParent = null, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the ListaCursoEditPanel panel that is
