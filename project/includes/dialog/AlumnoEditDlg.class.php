...
require(__DIALOG_GEN__ . '/AlumnoEditDlgGen.class.php');

/**
 * This is the customizable subclass for the edit dialog. This dialog is just a shell for the
 * AlumnoEditPanel class, and so you will not likely need to do major customizations here.
 ...
 *
 */
class AlumnoEditDlg extends AlumnoEditDlgGen {
	...
	public function __construct($objParent = null, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the AlumnoEditPanel panel that is
