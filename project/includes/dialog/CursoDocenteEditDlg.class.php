...
require(__DIALOG_GEN__ . '/CursoDocenteEditDlgGen.class.php');

/**
 * This is the customizable subclass for the edit dialog. This dialog is just a shell for the
 * CursoDocenteEditPanel class, and so you will not likely need to do major customizations here.
 ...
 *
 */
class CursoDocenteEditDlg extends CursoDocenteEditDlgGen {
	...
	public function __construct($objParent = null, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the CursoDocenteEditPanel panel that is
