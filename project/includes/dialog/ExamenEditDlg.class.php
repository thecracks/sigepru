...
require(__DIALOG_GEN__ . '/ExamenEditDlgGen.class.php');

/**
 * This is the customizable subclass for the edit dialog. This dialog is just a shell for the
 * ExamenEditPanel class, and so you will not likely need to do major customizations here.
 ...
 *
 */
class ExamenEditDlg extends ExamenEditDlgGen {
	...
	public function __construct($objParent = null, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the ExamenEditPanel panel that is
