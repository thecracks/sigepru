...
require(__DIALOG_GEN__ . '/NivelEditDlgGen.class.php');

/**
 * This is the customizable subclass for the edit dialog. This dialog is just a shell for the
 * NivelEditPanel class, and so you will not likely need to do major customizations here.
 ...
 *
 */
class NivelEditDlg extends NivelEditDlgGen {
	...
	public function __construct($objParent = null, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the NivelEditPanel panel that is
