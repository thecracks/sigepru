...
require(__DIALOG_GEN__ . '/RandomonlyEditDlgGen.class.php');

/**
 * This is the customizable subclass for the edit dialog. This dialog is just a shell for the
 * RandomonlyEditPanel class, and so you will not likely need to do major customizations here.
 ...
 *
 */
class RandomonlyEditDlg extends RandomonlyEditDlgGen {
	...
	public function __construct($objParent = null, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the RandomonlyEditPanel panel that is
