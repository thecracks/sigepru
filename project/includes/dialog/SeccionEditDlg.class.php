...
require(__DIALOG_GEN__ . '/SeccionEditDlgGen.class.php');

/**
 * This is the customizable subclass for the edit dialog. This dialog is just a shell for the
 * SeccionEditPanel class, and so you will not likely need to do major customizations here.
 ...
 *
 */
class SeccionEditDlg extends SeccionEditDlgGen {
	...
	public function __construct($objParent = null, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the SeccionEditPanel panel that is
