...
require(__DIALOG_GEN__ . '/RestaurantEditDlgGen.class.php');

/**
 * This is the customizable subclass for the edit dialog. This dialog is just a shell for the
 * RestaurantEditPanel class, and so you will not likely need to do major customizations here.
 ...
 *
 */
class RestaurantEditDlg extends RestaurantEditDlgGen {
	...
	public function __construct($objParent = null, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the RestaurantEditPanel panel that is
