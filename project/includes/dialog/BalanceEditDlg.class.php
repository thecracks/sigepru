...
require(__DIALOG_GEN__ . '/BalanceEditDlgGen.class.php');

/**
 * This is the customizable subclass for the edit dialog. This dialog is just a shell for the
 * BalanceEditPanel class, and so you will not likely need to do major customizations here.
 ...
 *
 */
class BalanceEditDlg extends BalanceEditDlgGen {
	...
	public function __construct($objParent = null, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the BalanceEditPanel panel that is
