...
require(__DIALOG_GEN__ . '/UsuarioEditDlgGen.class.php');

/**
 * This is the customizable subclass for the edit dialog. This dialog is just a shell for the
 * UsuarioEditPanel class, and so you will not likely need to do major customizations here.
 ...
 *
 */
class UsuarioEditDlg extends UsuarioEditDlgGen {
	...
	public function __construct($objParent = null, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the UsuarioEditPanel panel that is
