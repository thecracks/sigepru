...
require(__DIALOG_GEN__ . '/OfferEditDlgGen.class.php');

/**
 * This is the customizable subclass for the edit dialog. This dialog is just a shell for the
 * OfferEditPanel class, and so you will not likely need to do major customizations here.
 ...
 *
 */
class OfferEditDlg extends OfferEditDlgGen {
	...
	public function __construct($objParent = null, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the OfferEditPanel panel that is
