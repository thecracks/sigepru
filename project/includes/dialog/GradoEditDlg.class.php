...
require(__DIALOG_GEN__ . '/GradoEditDlgGen.class.php');

/**
 * This is the customizable subclass for the edit dialog. This dialog is just a shell for the
 * GradoEditPanel class, and so you will not likely need to do major customizations here.
 ...
 *
 */
class GradoEditDlg extends GradoEditDlgGen {
	...
	public function __construct($objParent = null, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the GradoEditPanel panel that is
