...
require(__DIALOG_GEN__ . '/AdministratorEditDlgGen.class.php');

/**
 * This is the customizable subclass for the edit dialog. This dialog is just a shell for the
 * AdministratorEditPanel class, and so you will not likely need to do major customizations here.
 ...
 *
 */
class AdministratorEditDlg extends AdministratorEditDlgGen {
	...
	public function __construct($objParent = null, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the AdministratorEditPanel panel that is
