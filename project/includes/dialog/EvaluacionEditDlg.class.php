...
require(__DIALOG_GEN__ . '/EvaluacionEditDlgGen.class.php');

/**
 * This is the customizable subclass for the edit dialog. This dialog is just a shell for the
 * EvaluacionEditPanel class, and so you will not likely need to do major customizations here.
 ...
 *
 */
class EvaluacionEditDlg extends EvaluacionEditDlgGen {
	...
	public function __construct($objParent = null, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the EvaluacionEditPanel panel that is
