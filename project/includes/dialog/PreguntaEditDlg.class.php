...
require(__DIALOG_GEN__ . '/PreguntaEditDlgGen.class.php');

/**
 * This is the customizable subclass for the edit dialog. This dialog is just a shell for the
 * PreguntaEditPanel class, and so you will not likely need to do major customizations here.
 ...
 *
 */
class PreguntaEditDlg extends PreguntaEditDlgGen {
	...
	public function __construct($objParent = null, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the PreguntaEditPanel panel that is
