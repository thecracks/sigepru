...
require(__DIALOG_GEN__ . '/AlternativaEditDlgGen.class.php');

/**
 * This is the customizable subclass for the edit dialog. This dialog is just a shell for the
 * AlternativaEditPanel class, and so you will not likely need to do major customizations here.
 ...
 *
 */
class AlternativaEditDlg extends AlternativaEditDlgGen {
	...
	public function __construct($objParent = null, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the AlternativaEditPanel panel that is
