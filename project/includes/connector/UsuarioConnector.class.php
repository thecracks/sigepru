<?php
	require(__MODEL_CONNECTOR_GEN__ . '/UsuarioConnectorGen.class.php');
	 ...
	 * must create a new QForm or QPanel which instantiates a UsuarioModelConnector
	 * class.
	 *
	 ...
	 */
	class UsuarioConnector extends UsuarioConnectorGen {
...
/*
		public function __construct($objParentObject, Usuario $objUsuario) {
			parent::__construct($objParentObject,$objUsuario);
			if ( !$this->blnEditMode ){
				$this->objUsuario->Initialize();
			}
		}
*/
	}