<?php
	require(__MODEL_CONNECTOR_GEN__ . '/OfferConnectorGen.class.php');
	 ...
	 * must create a new QForm or QPanel which instantiates a OfferModelConnector
	 * class.
	 *
	 ...
	 */
	class OfferConnector extends OfferConnectorGen {
