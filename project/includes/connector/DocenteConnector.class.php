<?php
	require(__MODEL_CONNECTOR_GEN__ . '/DocenteConnectorGen.class.php');
	 ...
	 * must create a new QForm or QPanel which instantiates a DocenteModelConnector
	 * class.
	 *
	 ...
	 */
	class DocenteConnector extends DocenteConnectorGen {
...
/*
		public function __construct($objParentObject, Docente $objDocente) {
			parent::__construct($objParentObject,$objDocente);
			if ( !$this->blnEditMode ){
				$this->objDocente->Initialize();
			}
		}
*/
	}