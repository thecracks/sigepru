<?php
require(__PANEL_GEN__ . '/RestaurantEditPanelGen.class.php');

/**
 * This is the customizable subclass for the edit panel functionality
 * of the Restaurant class. This is where you should create your customizations to the edit
 * panel that edits a restaurant record.
 *
 ...
 *
 */
class RestaurantEditPanel extends RestaurantEditPanelGen {
	public function __construct($objParent, $strControlId = null) {
		...
		//$this->Template = __PANEL_GEN__ . '/RestaurantEditPanel.tpl.php';
	}
}
