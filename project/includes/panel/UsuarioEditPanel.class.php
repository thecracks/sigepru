<?php
require(__PANEL_GEN__ . '/UsuarioEditPanelGen.class.php');

/**
 * This is the customizable subclass for the edit panel functionality
 * of the Usuario class. This is where you should create your customizations to the edit
 * panel that edits a usuario record.
 *
...
class UsuarioEditPanel extends UsuarioEditPanelGen {
	public function __construct($objParent, $strControlId = null) {
		...
		//$this->Template = __PANEL_GEN__ . '/UsuarioEditPanel.tpl.php';
	}
}
