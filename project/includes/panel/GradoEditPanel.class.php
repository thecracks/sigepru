<?php
require(__PANEL_GEN__ . '/GradoEditPanelGen.class.php');

/**
 * This is the customizable subclass for the edit panel functionality
 * of the Grado class. This is where you should create your customizations to the edit
 * panel that edits a grado record.
 *
 ...
 *
 */
class GradoEditPanel extends GradoEditPanelGen {
	public function __construct($objParent, $strControlId = null) {
		...
		//$this->Template = __PANEL_GEN__ . '/GradoEditPanel.tpl.php';
	}
}
