<?php
require(__PANEL_GEN__ . '/RandomEditPanelGen.class.php');

/**
 * This is the customizable subclass for the edit panel functionality
 * of the Random class. This is where you should create your customizations to the edit
 * panel that edits a random record.
 *
 ...
 *
 */
class RandomEditPanel extends RandomEditPanelGen {
	public function __construct($objParent, $strControlId = null) {
		...
		//$this->Template = __PANEL_GEN__ . '/RandomEditPanel.tpl.php';
	}
}
