<?php
require(__PANEL_GEN__ . '/DocenteEditPanelGen.class.php');

/**
 * This is the customizable subclass for the edit panel functionality
 * of the Docente class. This is where you should create your customizations to the edit
 * panel that edits a docente record.
 *
 ...
 *
 */
class DocenteEditPanel extends DocenteEditPanelGen {
	public function __construct($objParent, $strControlId = null) {
		...
		//$this->Template = __PANEL_GEN__ . '/DocenteEditPanel.tpl.php';
	}
}
