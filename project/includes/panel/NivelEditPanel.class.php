<?php
require(__PANEL_GEN__ . '/NivelEditPanelGen.class.php');

/**
 * This is the customizable subclass for the edit panel functionality
 * of the Nivel class. This is where you should create your customizations to the edit
 * panel that edits a nivel record.
 *
 ...
 *
 */
class NivelEditPanel extends NivelEditPanelGen {
	public function __construct($objParent, $strControlId = null) {
		...
		//$this->Template = __PANEL_GEN__ . '/NivelEditPanel.tpl.php';
	}
}
