...
/*
	...
	protected function dtgListaCursos_CreateColumns() {
		...
		$col = $this->dtgListaCursos->CreateNodeColumn("Createby", QQN::ListaCurso()->Createby);
		$col = $this->dtgListaCursos->CreateNodeColumn("Created", QQN::ListaCurso()->Created);
		$col = $this->dtgListaCursos->CreateNodeColumn("Updateby", QQN::ListaCurso()->Updateby);
		$col = $this->dtgListaCursos->CreateNodeColumn("Updated", QQN::ListaCurso()->Updated);
		$col = $this->dtgListaCursos->CreateNodeColumn("Active", QQN::ListaCurso()->Active);
	}
