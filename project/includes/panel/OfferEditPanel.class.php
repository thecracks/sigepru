<?php
require(__PANEL_GEN__ . '/OfferEditPanelGen.class.php');

/**
 * This is the customizable subclass for the edit panel functionality
 * of the Offer class. This is where you should create your customizations to the edit
 * panel that edits a offer record.
 *
 ...
 *
 */
class OfferEditPanel extends OfferEditPanelGen {
	public function __construct($objParent, $strControlId = null) {
		...
		//$this->Template = __PANEL_GEN__ . '/OfferEditPanel.tpl.php';
	}
}
