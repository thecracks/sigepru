...
/*
	...
	protected function dtgPreguntas_CreateColumns() {
		...
		$col = $this->dtgPreguntas->CreateNodeColumn("Pregunta Html", QQN::Pregunta()->PreguntaHtml);
		$col = $this->dtgPreguntas->CreateNodeColumn("Examen", QQN::Pregunta()->Examen);
		$col = $this->dtgPreguntas->CreateNodeColumn("Enunciado", QQN::Pregunta()->Enunciado);
		$col = $this->dtgPreguntas->CreateNodeColumn("Orden", QQN::Pregunta()->Orden);
		$col = $this->dtgPreguntas->CreateNodeColumn("Createby", QQN::Pregunta()->Createby);
		$col = $this->dtgPreguntas->CreateNodeColumn("Created", QQN::Pregunta()->Created);
		$col = $this->dtgPreguntas->CreateNodeColumn("Updateby", QQN::Pregunta()->Updateby);
		$col = $this->dtgPreguntas->CreateNodeColumn("Updated", QQN::Pregunta()->Updated);
		$col = $this->dtgPreguntas->CreateNodeColumn("Active", QQN::Pregunta()->Active);
	}
