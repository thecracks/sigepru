...
/*
	...
	protected function dtgCursos_CreateColumns() {
		...
		$col = $this->dtgCursos->CreateNodeColumn("Descripcion", QQN::Curso()->Descripcion);
		$col = $this->dtgCursos->CreateNodeColumn("Createby", QQN::Curso()->Createby);
		$col = $this->dtgCursos->CreateNodeColumn("Created", QQN::Curso()->Created);
		$col = $this->dtgCursos->CreateNodeColumn("Updateby", QQN::Curso()->Updateby);
		$col = $this->dtgCursos->CreateNodeColumn("Updated", QQN::Curso()->Updated);
		$col = $this->dtgCursos->CreateNodeColumn("Active", QQN::Curso()->Active);
	}
