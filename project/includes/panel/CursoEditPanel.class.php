<?php
require(__PANEL_GEN__ . '/CursoEditPanelGen.class.php');

/**
 * This is the customizable subclass for the edit panel functionality
 * of the Curso class. This is where you should create your customizations to the edit
 * panel that edits a curso record.
 *
 ...
 *
 */
class CursoEditPanel extends CursoEditPanelGen {
	public function __construct($objParent, $strControlId = null) {
		...
		//$this->Template = __PANEL_GEN__ . '/CursoEditPanel.tpl.php';
	}
}
