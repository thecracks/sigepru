<?php
require(__PANEL_GEN__ . '/BalanceEditPanelGen.class.php');

/**
 * This is the customizable subclass for the edit panel functionality
 * of the Balance class. This is where you should create your customizations to the edit
 * panel that edits a balance record.
 *
 ...
 *
 */
class BalanceEditPanel extends BalanceEditPanelGen {
	public function __construct($objParent, $strControlId = null) {
		...
		//$this->Template = __PANEL_GEN__ . '/BalanceEditPanel.tpl.php';
	}
}
