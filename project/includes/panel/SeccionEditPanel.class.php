<?php
require(__PANEL_GEN__ . '/SeccionEditPanelGen.class.php');

/**
 * This is the customizable subclass for the edit panel functionality
 * of the Seccion class. This is where you should create your customizations to the edit
 * panel that edits a seccion record.
 *
 ...
 *
 */
class SeccionEditPanel extends SeccionEditPanelGen {
	public function __construct($objParent, $strControlId = null) {
		...
		//$this->Template = __PANEL_GEN__ . '/SeccionEditPanel.tpl.php';
	}
}
