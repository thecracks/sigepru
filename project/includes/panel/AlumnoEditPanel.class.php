<?php
require(__PANEL_GEN__ . '/AlumnoEditPanelGen.class.php');

/**
 * This is the customizable subclass for the edit panel functionality
 * of the Alumno class. This is where you should create your customizations to the edit
 * panel that edits a alumno record.
 *
 ...
 *
 */
class AlumnoEditPanel extends AlumnoEditPanelGen {
	public function __construct($objParent, $strControlId = null) {
		...
		//$this->Template = __PANEL_GEN__ . '/AlumnoEditPanel.tpl.php';
	}
}
