...
/*
	...
	protected function dtgAlternativas_CreateColumns() {
		...
		$col = $this->dtgAlternativas->CreateNodeColumn("Descripcion", QQN::Alternativa()->Descripcion);
		...
		$col = $this->dtgAlternativas->CreateNodeColumn("Orden", QQN::Alternativa()->Orden);
		$col = $this->dtgAlternativas->CreateNodeColumn("Createby", QQN::Alternativa()->Createby);
		$col = $this->dtgAlternativas->CreateNodeColumn("Created", QQN::Alternativa()->Created);
		$col = $this->dtgAlternativas->CreateNodeColumn("Updateby", QQN::Alternativa()->Updateby);
		$col = $this->dtgAlternativas->CreateNodeColumn("Updated", QQN::Alternativa()->Updated);
		$col = $this->dtgAlternativas->CreateNodeColumn("Active", QQN::Alternativa()->Active);
	}
