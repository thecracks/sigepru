<?php
require(__PANEL_GEN__ . '/EvaluacionEditPanelGen.class.php');

/**
 * This is the customizable subclass for the edit panel functionality
 * of the Evaluacion class. This is where you should create your customizations to the edit
 * panel that edits a evaluacion record.
 *
 ...
 *
 */
class EvaluacionEditPanel extends EvaluacionEditPanelGen {
	public function __construct($objParent, $strControlId = null) {
		...
		//$this->Template = __PANEL_GEN__ . '/EvaluacionEditPanel.tpl.php';
	}
}
