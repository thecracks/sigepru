<?php
	/**
	 * This is a draft template file for the AlternativaListPanel.
     ...
     * Template property of the AlternativaListPanel to point to the new location.
	 **/
?>

<?= _r($this->pnlFilter); ?>
<?= _r($this->dtgAlternativas); ?>
<?= _r($this->pnlButtons); ?>
