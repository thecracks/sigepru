<?php
	/**
	 * This is a draft template file for the RandomonlyListPanel.
     ...
     * Template property of the RandomonlyListPanel to point to the new location.
	 **/
?>

<?= _r($this->pnlFilter); ?>
<?= _r($this->dtgRandomonlies); ?>
<?= _r($this->pnlButtons); ?>
