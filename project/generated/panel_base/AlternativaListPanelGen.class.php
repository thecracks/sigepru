...
/**
 * This is the base list class for the  Alternativa class.
 *
 ...
 */
abstract class AlternativaListPanelGen extends QPanel {
	/** @var QPanel **/
	protected $pnlFilter;
	...
	public function __construct($objParent, $strControlId = null) {
		...
		$this->dtgAlternativas_Create();
		$this->dtgAlternativas->SetDataBinder('BindData', $this);
	...
	**/
	protected function dtgAlternativas_Create() {
		$this->dtgAlternativas = new AlternativaList($this);
		$this->dtgAlternativas_CreateColumns();
		$this->dtgAlternativas_MakeEditable();
		$this->dtgAlternativas->RowParamsCallback = [$this, "dtgAlternativas_GetRowParams"];
			$this->dtgAlternativas->LinkedNode = QQN::Alternativa();
	}
	...
	**/
	protected function dtgAlternativas_CreateColumns() {
		$this->dtgAlternativas->CreateColumns();
	}

	protected function dtgAlternativas_MakeEditable() {
		$this->dtgAlternativas->AddAction(new QCellClickEvent(0, null, null, true), new QAjaxControlAction($this, 'dtgAlternativas_CellClick', null, null, QCellClickEvent::RowValue));
		$this->dtgAlternativas->AddCssClass('clickable-rows');
	}

	protected function dtgAlternativas_CellClick($strFormId, $strControlId, $strParameter) {
		if ($strParameter) {
			$this->EditItem($strParameter);
		}
	}
	public function dtgAlternativas_GetRowParams($objRowObject, $intRowIndex) {
	...
	public function BindData() {
		...
		$this->dtgAlternativas->BindData($objCondition);
	}
	...
	protected function EditItem ($strKey = null) {
		$strQuery = '';
		if ($strKey) {
			$strQuery =  '?strAlternativaId=' . $strKey;
		}
		$strEditPageUrl = __VIRTUAL_DIRECTORY__ . __FORMS__ . '/alternativa_edit.php' . $strQuery;
