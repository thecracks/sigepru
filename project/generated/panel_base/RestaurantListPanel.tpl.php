<?php
	/**
	 * This is a draft template file for the RestaurantListPanel.
     ...
     * Template property of the RestaurantListPanel to point to the new location.
	 **/
?>

<?= _r($this->pnlFilter); ?>
<?= _r($this->dtgRestaurants); ?>
<?= _r($this->pnlButtons); ?>
