<?php
	/**
	 * This is a draft template file for the OrganizationtypeEditPanel.
     ...
     * Template property of the OrganizationtypeEditPanel to point to the new location.
	 **/
?>

<?= _r($this->lblIdOrganizationType); ?>
<?= _r($this->txtName); ?>
