<?php
	/**
	 * This is a draft template file for the ListaCursoListPanel.
     ...
     * Template property of the ListaCursoListPanel to point to the new location.
	 **/
?>

<?= _r($this->pnlFilter); ?>
<?= _r($this->dtgListaCursos); ?>
<?= _r($this->pnlButtons); ?>
