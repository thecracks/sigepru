...
/**
 * This is the base list class for the  Random class.
 *
 ...
 */
abstract class RandomListPanelGen extends QPanel {
	/** @var QPanel **/
	protected $pnlFilter;
	...
	public function __construct($objParent, $strControlId = null) {
		...
		$this->dtgRandoms_Create();
		$this->dtgRandoms->SetDataBinder('BindData', $this);
	...
	**/
	protected function dtgRandoms_Create() {
		$this->dtgRandoms = new RandomList($this);
		$this->dtgRandoms_CreateColumns();
		$this->dtgRandoms_MakeEditable();
		$this->dtgRandoms->RowParamsCallback = [$this, "dtgRandoms_GetRowParams"];
			$this->dtgRandoms->LinkedNode = QQN::Random();
	}
	...
	**/
	protected function dtgRandoms_CreateColumns() {
		$this->dtgRandoms->CreateColumns();
	}

	protected function dtgRandoms_MakeEditable() {
		$this->dtgRandoms->AddAction(new QCellClickEvent(0, null, null, true), new QAjaxControlAction($this, 'dtgRandoms_CellClick', null, null, QCellClickEvent::RowValue));
		$this->dtgRandoms->AddCssClass('clickable-rows');
	}

	protected function dtgRandoms_CellClick($strFormId, $strControlId, $strParameter) {
		if ($strParameter) {
			$this->EditItem($strParameter);
		}
	}
	public function dtgRandoms_GetRowParams($objRowObject, $intRowIndex) {
	...
	public function BindData() {
		...
		$this->dtgRandoms->BindData($objCondition);
	}
	...
	protected function GetCondition() {
		...
		if (is_null($strSearchValue) || $strSearchValue === '') {
			...
			return QQ::OrCondition(
				QQ::Like(QQN::Random()->RandomId, "%" . $strSearchValue . "%")
			);
		}
	...
	protected function EditItem ($strKey = null) {
		...
		$strEditPageUrl = __VIRTUAL_DIRECTORY__ . __FORMS__ . '/random_edit.php' . $strQuery;
