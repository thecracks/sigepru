<?php
	/**
	 * This is a draft template file for the CursoDocenteListPanel.
     ...
     * Template property of the CursoDocenteListPanel to point to the new location.
	 **/
?>

<?= _r($this->pnlFilter); ?>
<?= _r($this->dtgCursoDocentes); ?>
<?= _r($this->pnlButtons); ?>
