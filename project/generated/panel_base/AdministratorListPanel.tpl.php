<?php
	/**
	 * This is a draft template file for the AdministratorListPanel.
     ...
     * Template property of the AdministratorListPanel to point to the new location.
	 **/
?>

<?= _r($this->pnlFilter); ?>
<?= _r($this->dtgAdministrators); ?>
<?= _r($this->pnlButtons); ?>
