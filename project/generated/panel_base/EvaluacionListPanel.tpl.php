<?php
	/**
	 * This is a draft template file for the EvaluacionListPanel.
     ...
     * Template property of the EvaluacionListPanel to point to the new location.
	 **/
?>

<?= _r($this->pnlFilter); ?>
<?= _r($this->dtgEvaluacions); ?>
<?= _r($this->pnlButtons); ?>
