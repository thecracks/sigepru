...
class ExamenGen extends QBaseClass implements IteratorAggregate, JsonSerializable {
    ...
    QDatabaseRowBase $objDbRow, $strAliasPrefix = null, QQNode $objExpandAsArrayNode = null, $objPreviousItemArray = null, $strColumnAliasArray = array(), $blnCheckDuplicate = false, $strParentExpansionKey = null, $objExpansionParent = null) {
    ...
    public static function LoadArrayByCursoDocenteId($strCursoDocenteId, $objOptionalClauses = null) {
        ...
        try {
            return Examen::QueryArray(
                            QQ::Equal(QQN::Examen()->CursoDocenteId, $strCursoDocenteId), $objOptionalClauses);
        } catch (QCallerException $objExc) {
            $objExc->IncrementOffset();
            throw $objExc;
        }
    ...
    public function Save($blnForceInsert = false, $blnForceUpdate = false) {
        ...
        try {
            if ((!$this->__blnRestored && !$blnForceUpdate) || ($blnForceInsert)) {
                ...
                $this->Createby = "11111111111";
                $this->Updateby = "11111111111";
