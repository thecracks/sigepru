...
include (__PANEL__ . '/EvaluacionEditPanel.class.php');

/**
 * This is the EvaluacionEditDlgGen class.  It uses the code-generated
 * EvaluacionEditPanel class, which has all the controls for editing
 * a record in the evaluacion table.
 *
 *
 * @package My QCubed Application
 * @subpackage Dialogs
 */
class EvaluacionEditDlgGen extends QDialog {
	...
	protected function CreateButtons() {
		...
		$this->AddButton(QApplication::Translate('Delete'), 'delete', false, false,
			sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'),  QApplication::Translate('Evaluacion')),
	...
	public function Load ($strEvaluacionId = null) {
		...
		$blnIsNew = is_null($strEvaluacionId);
