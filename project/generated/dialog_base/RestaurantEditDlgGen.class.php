...
include (__PANEL__ . '/RestaurantEditPanel.class.php');

/**
 * This is the RestaurantEditDlgGen class.  It uses the code-generated
 * RestaurantEditPanel class, which has all the controls for editing
 ...
 * @subpackage Dialogs
 */
class RestaurantEditDlgGen extends QDialog {
	...
	protected function CreateButtons() {
		...
		$this->AddButton(QApplication::Translate('Delete'), 'delete', false, false,
			sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'),  QApplication::Translate('Restaurant')),
	...
	public function Load ($intIdRestaurant = null) {
		...
		$blnIsNew = is_null($intIdRestaurant);
