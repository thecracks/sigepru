...
include (__PANEL__ . '/PreguntaEditPanel.class.php');

/**
 * This is the PreguntaEditDlgGen class.  It uses the code-generated
 * PreguntaEditPanel class, which has all the controls for editing
 * a record in the pregunta table.
 *
 *
 * @package My QCubed Application
 * @subpackage Dialogs
 */
class PreguntaEditDlgGen extends QDialog {
	...
	protected function CreateButtons() {
		...
		$this->AddButton(QApplication::Translate('Delete'), 'delete', false, false,
			sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'),  QApplication::Translate('Pregunta')),
	...
	public function Load ($strPreguntaId = null) {
		...
		$blnIsNew = is_null($strPreguntaId);
