...
include (__PANEL__ . '/SeccionEditPanel.class.php');

/**
 * This is the SeccionEditDlgGen class.  It uses the code-generated
 * SeccionEditPanel class, which has all the controls for editing
 * a record in the seccion table.
 *
 *
 * @package My QCubed Application
 * @subpackage Dialogs
 */
class SeccionEditDlgGen extends QDialog {
	...
	protected function CreateButtons() {
		...
		$this->AddButton(QApplication::Translate('Delete'), 'delete', false, false,
			sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'),  QApplication::Translate('Seccion')),
