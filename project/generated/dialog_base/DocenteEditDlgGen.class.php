...
include (__PANEL__ . '/DocenteEditPanel.class.php');

/**
 * This is the DocenteEditDlgGen class.  It uses the code-generated
 * DocenteEditPanel class, which has all the controls for editing
 * a record in the docente table.
 *
 *
 * @package My QCubed Application
 * @subpackage Dialogs
 */
class DocenteEditDlgGen extends QDialog {
	...
	protected function CreateButtons() {
		...
		$this->AddButton(QApplication::Translate('Delete'), 'delete', false, false,
			sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'),  QApplication::Translate('Docente')),
