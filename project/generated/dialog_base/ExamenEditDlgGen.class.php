...
include (__PANEL__ . '/ExamenEditPanel.class.php');

/**
 * This is the ExamenEditDlgGen class.  It uses the code-generated
 * ExamenEditPanel class, which has all the controls for editing
 * a record in the examen table.
 *
 *
 * @package My QCubed Application
 * @subpackage Dialogs
 */
class ExamenEditDlgGen extends QDialog {
	...
	protected function CreateButtons() {
		...
		$this->AddButton(QApplication::Translate('Delete'), 'delete', false, false,
			sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'),  QApplication::Translate('Examen')),
