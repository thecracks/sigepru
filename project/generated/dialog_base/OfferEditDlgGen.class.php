...
include (__PANEL__ . '/OfferEditPanel.class.php');

/**
 * This is the OfferEditDlgGen class.  It uses the code-generated
 * OfferEditPanel class, which has all the controls for editing
 ...
 * @subpackage Dialogs
 */
class OfferEditDlgGen extends QDialog {
	...
	protected function CreateButtons() {
		...
		$this->AddButton(QApplication::Translate('Delete'), 'delete', false, false,
			sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'),  QApplication::Translate('Offer')),
