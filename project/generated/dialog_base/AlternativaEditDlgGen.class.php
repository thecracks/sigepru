...
include (__PANEL__ . '/AlternativaEditPanel.class.php');

/**
 * This is the AlternativaEditDlgGen class.  It uses the code-generated
 * AlternativaEditPanel class, which has all the controls for editing
 * a record in the alternativa table.
 *
 *
 * @package My QCubed Application
 * @subpackage Dialogs
 */
class AlternativaEditDlgGen extends QDialog {
	...
	protected function CreateButtons() {
		...
		$this->AddButton(QApplication::Translate('Delete'), 'delete', false, false,
			sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'),  QApplication::Translate('Alternativa')),
	...
	public function Load ($strAlternativaId = null) {
		...
		$blnIsNew = is_null($strAlternativaId);
