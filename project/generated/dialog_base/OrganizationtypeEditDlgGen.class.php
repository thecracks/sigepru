...
include (__PANEL__ . '/OrganizationtypeEditPanel.class.php');

/**
 * This is the OrganizationtypeEditDlgGen class.  It uses the code-generated
 * OrganizationtypeEditPanel class, which has all the controls for editing
 * a record in the organizationtype table.
 *
 *
 * @package My QCubed Application
 * @subpackage Dialogs
 */
class OrganizationtypeEditDlgGen extends QDialog {
	...
	protected function CreateButtons() {
		...
		$this->AddButton(QApplication::Translate('Delete'), 'delete', false, false,
			sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'),  QApplication::Translate('Organizationtype')),
	...
	public function Load ($intIdOrganizationType = null) {
		...
		$blnIsNew = is_null($intIdOrganizationType);
