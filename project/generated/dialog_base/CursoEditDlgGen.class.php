...
include (__PANEL__ . '/CursoEditPanel.class.php');

/**
 * This is the CursoEditDlgGen class.  It uses the code-generated
 * CursoEditPanel class, which has all the controls for editing
 * a record in the curso table.
 *
 *
 * @package My QCubed Application
 * @subpackage Dialogs
 */
class CursoEditDlgGen extends QDialog {
	...
	protected function CreateButtons() {
		...
		$this->AddButton(QApplication::Translate('Delete'), 'delete', false, false,
			sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'),  QApplication::Translate('Curso')),
