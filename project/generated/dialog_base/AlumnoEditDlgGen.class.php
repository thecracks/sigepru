...
include (__PANEL__ . '/AlumnoEditPanel.class.php');

/**
 * This is the AlumnoEditDlgGen class.  It uses the code-generated
 * AlumnoEditPanel class, which has all the controls for editing
 * a record in the alumno table.
 *
 *
 * @package My QCubed Application
 * @subpackage Dialogs
 */
class AlumnoEditDlgGen extends QDialog {
	...
	protected function CreateButtons() {
		...
		$this->AddButton(QApplication::Translate('Delete'), 'delete', false, false,
			sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'),  QApplication::Translate('Alumno')),
