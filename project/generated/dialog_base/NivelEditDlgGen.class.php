...
include (__PANEL__ . '/NivelEditPanel.class.php');

/**
 * This is the NivelEditDlgGen class.  It uses the code-generated
 * NivelEditPanel class, which has all the controls for editing
 * a record in the nivel table.
 *
 *
 * @package My QCubed Application
 * @subpackage Dialogs
 */
class NivelEditDlgGen extends QDialog {
	...
	protected function CreateButtons() {
		...
		$this->AddButton(QApplication::Translate('Delete'), 'delete', false, false,
			sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'),  QApplication::Translate('Nivel')),
