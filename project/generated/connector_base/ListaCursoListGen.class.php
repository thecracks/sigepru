 ...
 * subclasses a ListaCurso class and can be used to display
 * a collection of ListaCurso objects.
 *
...
class ListaCursoListGen extends QDataGrid {
	/**
	...
	public function CreateColumns() {
		$this->colListaCursoId = $this->CreateNodeColumn("Lista Curso Id", QQN::ListaCurso()->ListaCursoId);
		$this->colAlumno = $this->CreateNodeColumn("Alumno", QQN::ListaCurso()->Alumno);
		$this->colCursoDocente = $this->CreateNodeColumn("Curso Docente", QQN::ListaCurso()->CursoDocente);
		$this->colCreateby = $this->CreateNodeColumn("Createby", QQN::ListaCurso()->Createby);
		$this->colCreated = $this->CreateNodeColumn("Created", QQN::ListaCurso()->Created);
		$this->colUpdateby = $this->CreateNodeColumn("Updateby", QQN::ListaCurso()->Updateby);
		$this->colUpdated = $this->CreateNodeColumn("Updated", QQN::ListaCurso()->Updated);
		$this->colActive = $this->CreateNodeColumn("Active", QQN::ListaCurso()->Active);
	}
	...
	**/
	public function BindData($objAdditionalCondition = null, $objAdditionalClauses = null) {
		...
		if ($this->Paginator) {
			$this->TotalItemCount = ListaCurso::QueryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = ListaCurso::QueryArray($objCondition, $objClauses);
	}
