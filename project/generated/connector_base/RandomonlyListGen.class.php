 ...
 * subclasses a Randomonly class and can be used to display
 * a collection of Randomonly objects.
 *
...
class RandomonlyListGen extends QDataGrid {
	/**
	...
	public function CreateColumns() {
		$this->colRandomId = $this->CreateNodeColumn("Random Id", QQN::Randomonly()->RandomId);
	}
	...
	**/
	public function BindData($objAdditionalCondition = null, $objAdditionalClauses = null) {
		...
		if ($this->Paginator) {
			$this->TotalItemCount = Randomonly::QueryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = Randomonly::QueryArray($objCondition, $objClauses);
	}
