 ...
 * subclasses a Docente class and can be used to display
 * a collection of Docente objects.
 *
...
class DocenteListGen extends QDataGrid {
	/**
	...
	public function CreateColumns() {
		$this->colDocente = $this->CreateNodeColumn("Docente", QQN::Docente()->Docente);
		$this->colCreateby = $this->CreateNodeColumn("Createby", QQN::Docente()->Createby);
		$this->colCreated = $this->CreateNodeColumn("Created", QQN::Docente()->Created);
		$this->colUpdateby = $this->CreateNodeColumn("Updateby", QQN::Docente()->Updateby);
		$this->colUpdated = $this->CreateNodeColumn("Updated", QQN::Docente()->Updated);
		$this->colActive = $this->CreateNodeColumn("Active", QQN::Docente()->Active);
	}
	...
	**/
	public function BindData($objAdditionalCondition = null, $objAdditionalClauses = null) {
		...
		if ($this->Paginator) {
			$this->TotalItemCount = Docente::QueryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = Docente::QueryArray($objCondition, $objClauses);
	}
