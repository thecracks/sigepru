 ...
 * subclasses a Balance class and can be used to display
 * a collection of Balance objects.
 *
...
class BalanceListGen extends QDataGrid {
	/**
	...
	public $colDate;
	/** @var QHtmlTableNodeColumn */
	public $colAmountExchangedCoins;
	/** @var QHtmlTableNodeColumn */
	public $colIdUserObject;
	/** @var QHtmlTableNodeColumn */
	public $colIdOfferObject;
	...
	public function CreateColumns() {
		$this->colIdBalance = $this->CreateNodeColumn("Id Balance", QQN::Balance()->IdBalance);
		$this->colDate = $this->CreateNodeColumn("Date", QQN::Balance()->Date);
		$this->colAmountExchangedCoins = $this->CreateNodeColumn("Amount Exchanged Coins", QQN::Balance()->AmountExchangedCoins);
		$this->colIdUserObject = $this->CreateNodeColumn("Id User Object", QQN::Balance()->IdUserObject);
		$this->colIdOfferObject = $this->CreateNodeColumn("Id Offer Object", QQN::Balance()->IdOfferObject);
	}
	...
	**/
	public function BindData($objAdditionalCondition = null, $objAdditionalClauses = null) {
		...
		if ($this->Paginator) {
			$this->TotalItemCount = Balance::QueryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = Balance::QueryArray($objCondition, $objClauses);
	}
