 ...
 * subclasses a Pregunta class and can be used to display
 * a collection of Pregunta objects.
 *
...
class PreguntaListGen extends QDataGrid {
	/**
	...
	**/
	public function BindData($objAdditionalCondition = null, $objAdditionalClauses = null) {
		...
		if ($this->Paginator) {
			$this->TotalItemCount = Pregunta::QueryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = Pregunta::QueryArray($objCondition, $objClauses);
	}
