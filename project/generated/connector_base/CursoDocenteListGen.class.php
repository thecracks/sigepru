 ...
 * subclasses a CursoDocente class and can be used to display
 * a collection of CursoDocente objects.
 *
...
class CursoDocenteListGen extends QDataGrid {
	/**
	...
	public function CreateColumns() {
		$this->colCursoDocenteId = $this->CreateNodeColumn("Curso Docente Id", QQN::CursoDocente()->CursoDocenteId);
		$this->colCurso = $this->CreateNodeColumn("Curso", QQN::CursoDocente()->Curso);
		$this->colSeccion = $this->CreateNodeColumn("Seccion", QQN::CursoDocente()->Seccion);
		$this->colDocente = $this->CreateNodeColumn("Docente", QQN::CursoDocente()->Docente);
		$this->colGrado = $this->CreateNodeColumn("Grado", QQN::CursoDocente()->Grado);
		$this->colCreateby = $this->CreateNodeColumn("Createby", QQN::CursoDocente()->Createby);
		$this->colCreated = $this->CreateNodeColumn("Created", QQN::CursoDocente()->Created);
		$this->colUpdateby = $this->CreateNodeColumn("Updateby", QQN::CursoDocente()->Updateby);
		$this->colUpdated = $this->CreateNodeColumn("Updated", QQN::CursoDocente()->Updated);
		$this->colActive = $this->CreateNodeColumn("Active", QQN::CursoDocente()->Active);
	}
	...
	**/
	public function BindData($objAdditionalCondition = null, $objAdditionalClauses = null) {
		...
		if ($this->Paginator) {
			$this->TotalItemCount = CursoDocente::QueryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = CursoDocente::QueryArray($objCondition, $objClauses);
	}
