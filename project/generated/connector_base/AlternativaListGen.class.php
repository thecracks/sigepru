 ...
 * subclasses a Alternativa class and can be used to display
 * a collection of Alternativa objects.
 *
...
class AlternativaListGen extends QDataGrid {
	/**
	...
	**/
	public function BindData($objAdditionalCondition = null, $objAdditionalClauses = null) {
		...
		if ($this->Paginator) {
			$this->TotalItemCount = Alternativa::QueryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = Alternativa::QueryArray($objCondition, $objClauses);
	}
