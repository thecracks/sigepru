 ...
 * subclasses a Grado class and can be used to display
 * a collection of Grado objects.
 *
...
class GradoListGen extends QDataGrid {
	/**
	...
	public function CreateColumns() {
		$this->colGradoId = $this->CreateNodeColumn("Grado Id", QQN::Grado()->GradoId);
		$this->colGrado = $this->CreateNodeColumn("Grado", QQN::Grado()->Grado);
		$this->colCreateby = $this->CreateNodeColumn("Createby", QQN::Grado()->Createby);
		$this->colCreated = $this->CreateNodeColumn("Created", QQN::Grado()->Created);
		$this->colUpdateby = $this->CreateNodeColumn("Updateby", QQN::Grado()->Updateby);
		$this->colUpdated = $this->CreateNodeColumn("Updated", QQN::Grado()->Updated);
		$this->colActive = $this->CreateNodeColumn("Active", QQN::Grado()->Active);
		$this->colNivel = $this->CreateNodeColumn("Nivel", QQN::Grado()->Nivel);
	}
	...
	**/
	public function BindData($objAdditionalCondition = null, $objAdditionalClauses = null) {
		...
		if ($this->Paginator) {
			$this->TotalItemCount = Grado::QueryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = Grado::QueryArray($objCondition, $objClauses);
	}
