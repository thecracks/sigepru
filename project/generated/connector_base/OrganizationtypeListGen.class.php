 ...
 * subclasses a Organizationtype class and can be used to display
 * a collection of Organizationtype objects.
 *
...
class OrganizationtypeListGen extends QDataGrid {
	/**
	...
	public function __construct($objParent, $strControlId = false) {
		...
		$this->Watch(QQN::Organizationtype());
	}
	...
	public function CreateColumns() {
		$this->colIdOrganizationType = $this->CreateNodeColumn("Id Organization Type", QQN::Organizationtype()->IdOrganizationType);
		$this->colName = $this->CreateNodeColumn("Name", QQN::Organizationtype()->Name);
		$this->colDescription = $this->CreateNodeColumn("Description", QQN::Organizationtype()->Description);
	}
	...
	**/
	public function BindData($objAdditionalCondition = null, $objAdditionalClauses = null) {
		...
		if ($this->Paginator) {
			$this->TotalItemCount = Organizationtype::QueryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = Organizationtype::QueryArray($objCondition, $objClauses);
	}
