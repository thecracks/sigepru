 ...
 * subclasses a Administrator class and can be used to display
 * a collection of Administrator objects.
 *
...
class AdministratorListGen extends QDataGrid {
	/**
	...
	public function CreateColumns() {
		$this->colIdAdministrator = $this->CreateNodeColumn("Id Administrator", QQN::Administrator()->IdAdministrator);
		$this->colEmail = $this->CreateNodeColumn("Email", QQN::Administrator()->Email);
		$this->colPassword = $this->CreateNodeColumn("Password", QQN::Administrator()->Password);
		$this->colFirstName = $this->CreateNodeColumn("First Name", QQN::Administrator()->FirstName);
		$this->colLastName = $this->CreateNodeColumn("Last Name", QQN::Administrator()->LastName);
		$this->colAddress = $this->CreateNodeColumn("Address", QQN::Administrator()->Address);
		$this->colPhone = $this->CreateNodeColumn("Phone", QQN::Administrator()->Phone);
	}
	...
	**/
	public function BindData($objAdditionalCondition = null, $objAdditionalClauses = null) {
		...
		if ($this->Paginator) {
			$this->TotalItemCount = Administrator::QueryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = Administrator::QueryArray($objCondition, $objClauses);
	}
