 ...
 * subclasses a Evaluacion class and can be used to display
 * a collection of Evaluacion objects.
 *
...
class EvaluacionListGen extends QDataGrid {
	/**
	...
	public function CreateColumns() {
		$this->colEvaluacionId = $this->CreateNodeColumn("Evaluacion Id", QQN::Evaluacion()->EvaluacionId);
		$this->colHtml = $this->CreateNodeColumn("Html", QQN::Evaluacion()->Html);
	}
	...
	**/
	public function BindData($objAdditionalCondition = null, $objAdditionalClauses = null) {
		...
		if ($this->Paginator) {
			$this->TotalItemCount = Evaluacion::QueryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = Evaluacion::QueryArray($objCondition, $objClauses);
	}
