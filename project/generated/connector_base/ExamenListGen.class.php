 ...
 * subclasses a Examen class and can be used to display
 * a collection of Examen objects.
 *
...
class ExamenListGen extends QDataGrid {
	/**
	...
	public $colExamenId;
	/** @var QHtmlTableNodeColumn */
	public $colCursoDocente;
	/** @var QHtmlTableNodeColumn */
	public $colCabeceraHtml;
	/** @var QHtmlTableNodeColumn */
	public $colTipo;
	/** @var QHtmlTableNodeColumn */
	public $colCreateby;
	...
	public function CreateColumns() {
		$this->colExamenId = $this->CreateNodeColumn("Examen Id", QQN::Examen()->ExamenId);
		$this->colCursoDocente = $this->CreateNodeColumn("Curso Docente", QQN::Examen()->CursoDocente);
		$this->colCabeceraHtml = $this->CreateNodeColumn("Cabecera Html", QQN::Examen()->CabeceraHtml);
		$this->colTipo = $this->CreateNodeColumn("Tipo", QQN::Examen()->Tipo);
		$this->colCreateby = $this->CreateNodeColumn("Createby", QQN::Examen()->Createby);
		$this->colCreated = $this->CreateNodeColumn("Created", QQN::Examen()->Created);
		$this->colUpdateby = $this->CreateNodeColumn("Updateby", QQN::Examen()->Updateby);
		$this->colUpdated = $this->CreateNodeColumn("Updated", QQN::Examen()->Updated);
		$this->colActive = $this->CreateNodeColumn("Active", QQN::Examen()->Active);
	}
	...
	**/
	public function BindData($objAdditionalCondition = null, $objAdditionalClauses = null) {
		...
		if ($this->Paginator) {
			$this->TotalItemCount = Examen::QueryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = Examen::QueryArray($objCondition, $objClauses);
	}
