 ...
 * subclasses a Offer class and can be used to display
 * a collection of Offer objects.
 *
...
class OfferListGen extends QDataGrid {
	/**
	...
	/** @var QHtmlTableNodeColumn */
	public $colOfferedCoins;
	/** @var QHtmlTableNodeColumn */
	public $colDateFrom;
	/** @var QHtmlTableNodeColumn */
	public $colDateTo;
	/** @var QHtmlTableNodeColumn */
	public $colIdRestaurantObject;
	/** @var QHtmlTableNodeColumn */
	public $colMaxOffers;
	/** @var QHtmlTableNodeColumn */
	public $colAppliedOffers;
	/** @var QHtmlTableNodeColumn */
	public $colMaxCoins;
	/** @var QHtmlTableNodeColumn */
	public $colStatus;
	...
	public function CreateColumns() {
		$this->colIdOffer = $this->CreateNodeColumn("Id Offer", QQN::Offer()->IdOffer);
		$this->colDescription = $this->CreateNodeColumn("Description", QQN::Offer()->Description);
		$this->colOfferedCoins = $this->CreateNodeColumn("Offered Coins", QQN::Offer()->OfferedCoins);
		$this->colDateFrom = $this->CreateNodeColumn("Date From", QQN::Offer()->DateFrom);
		$this->colDateTo = $this->CreateNodeColumn("Date To", QQN::Offer()->DateTo);
		$this->colIdRestaurantObject = $this->CreateNodeColumn("Id Restaurant Object", QQN::Offer()->IdRestaurantObject);
		$this->colMaxOffers = $this->CreateNodeColumn("Max Offers", QQN::Offer()->MaxOffers);
		$this->colAppliedOffers = $this->CreateNodeColumn("Applied Offers", QQN::Offer()->AppliedOffers);
		$this->colMaxCoins = $this->CreateNodeColumn("Max Coins", QQN::Offer()->MaxCoins);
		$this->colStatus = $this->CreateNodeColumn("Status", QQN::Offer()->Status);
	}
	...
	**/
	public function BindData($objAdditionalCondition = null, $objAdditionalClauses = null) {
		...
		if ($this->Paginator) {
			$this->TotalItemCount = Offer::QueryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = Offer::QueryArray($objCondition, $objClauses);
	}
