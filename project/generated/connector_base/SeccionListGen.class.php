 ...
 * subclasses a Seccion class and can be used to display
 * a collection of Seccion objects.
 *
...
class SeccionListGen extends QDataGrid {
	/**
	...
	public function CreateColumns() {
		$this->colSeccionId = $this->CreateNodeColumn("Seccion Id", QQN::Seccion()->SeccionId);
		$this->colSeccion = $this->CreateNodeColumn("Seccion", QQN::Seccion()->Seccion);
		$this->colLetra = $this->CreateNodeColumn("Letra", QQN::Seccion()->Letra);
		$this->colCreateby = $this->CreateNodeColumn("Createby", QQN::Seccion()->Createby);
		$this->colCreated = $this->CreateNodeColumn("Created", QQN::Seccion()->Created);
		$this->colUpdateby = $this->CreateNodeColumn("Updateby", QQN::Seccion()->Updateby);
		$this->colUpdated = $this->CreateNodeColumn("Updated", QQN::Seccion()->Updated);
		$this->colActive = $this->CreateNodeColumn("Active", QQN::Seccion()->Active);
	}
	...
	**/
	public function BindData($objAdditionalCondition = null, $objAdditionalClauses = null) {
		...
		if ($this->Paginator) {
			$this->TotalItemCount = Seccion::QueryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = Seccion::QueryArray($objCondition, $objClauses);
	}
