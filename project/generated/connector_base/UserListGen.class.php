...
class UserListGen extends QDataGrid {
	/**
	...
	public $colBirthday;
	/** @var QHtmlTableNodeColumn */
	public $colImagePhoto;
	/** @var QHtmlTableNodeColumn */
	public $colStatusUser;
	/** @var QHtmlTableNodeColumn */
	public $colWalletAddress;
	/** @var QHtmlTableNodeColumn */
	public $colUserType;
	/** @var QHtmlTableNodeColumn */
	public $colTotalqtycoins;
	...
	public function CreateColumns() {
		$this->colIdUser = $this->CreateNodeColumn("Id User", QQN::User()->IdUser);
		...
		$this->colFirstName = $this->CreateNodeColumn("First Name", QQN::User()->FirstName);
		$this->colMiddleName = $this->CreateNodeColumn("Middle Name", QQN::User()->MiddleName);
		$this->colLastName = $this->CreateNodeColumn("Last Name", QQN::User()->LastName);
		$this->colCountry = $this->CreateNodeColumn("Country", QQN::User()->Country);
		$this->colCity = $this->CreateNodeColumn("City", QQN::User()->City);
		$this->colPhone = $this->CreateNodeColumn("Phone", QQN::User()->Phone);
		$this->colBirthday = $this->CreateNodeColumn("Birthday", QQN::User()->Birthday);
		$this->colImagePhoto = $this->CreateNodeColumn("Image Photo", QQN::User()->ImagePhoto);
		$this->colStatusUser = $this->CreateNodeColumn("Status User", QQN::User()->StatusUser);
		$this->colWalletAddress = $this->CreateNodeColumn("Wallet Address", QQN::User()->WalletAddress);
		$this->colUserType = $this->CreateNodeColumn("User Type", QQN::User()->UserType);
		$this->colTotalqtycoins = $this->CreateNodeColumn("Totalqtycoins", QQN::User()->Totalqtycoins);
	}
