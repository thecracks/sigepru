 ...
 * subclasses a Random class and can be used to display
...
class RandomListGen extends QDataGrid {
	/**
	...
	public function CreateColumns() {
		$this->colRandomId = $this->CreateNodeColumn("Random Id", QQN::Random()->RandomId);
	}
	...
	**/
	public function BindData($objAdditionalCondition = null, $objAdditionalClauses = null) {
		...
		if ($this->Paginator) {
			$this->TotalItemCount = Random::QueryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = Random::QueryArray($objCondition, $objClauses);
	}
