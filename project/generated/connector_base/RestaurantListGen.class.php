 ...
 * subclasses a Restaurant class and can be used to display
 * a collection of Restaurant objects.
 *
...
class RestaurantListGen extends QDataGrid {
	/**
	...
	public function CreateColumns() {
		$this->colIdRestaurant = $this->CreateNodeColumn("Id Restaurant", QQN::Restaurant()->IdRestaurant);
		$this->colCountry = $this->CreateNodeColumn("Country", QQN::Restaurant()->Country);
		$this->colCity = $this->CreateNodeColumn("City", QQN::Restaurant()->City);
		$this->colAddress = $this->CreateNodeColumn("Address", QQN::Restaurant()->Address);
		$this->colRestaurantName = $this->CreateNodeColumn("Restaurant Name", QQN::Restaurant()->RestaurantName);
		$this->colLongitude = $this->CreateNodeColumn("Longitude", QQN::Restaurant()->Longitude);
		$this->colLatitude = $this->CreateNodeColumn("Latitude", QQN::Restaurant()->Latitude);
		$this->colQrCode = $this->CreateNodeColumn("Qr Code", QQN::Restaurant()->QrCode);
		$this->colQtycoins = $this->CreateNodeColumn("Qtycoins", QQN::Restaurant()->Qtycoins);
		$this->colIdUserObject = $this->CreateNodeColumn("Id User Object", QQN::Restaurant()->IdUserObject);
		$this->colType = $this->CreateNodeColumn("Type", QQN::Restaurant()->Type);
		$this->colLogo = $this->CreateNodeColumn("Logo", QQN::Restaurant()->Logo);
		$this->colStatus = $this->CreateNodeColumn("Status", QQN::Restaurant()->Status);
	}
	...
	**/
	public function BindData($objAdditionalCondition = null, $objAdditionalClauses = null) {
		...
		if ($this->Paginator) {
			$this->TotalItemCount = Restaurant::QueryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = Restaurant::QueryArray($objCondition, $objClauses);
	}
