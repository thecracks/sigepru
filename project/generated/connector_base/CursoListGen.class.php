 ...
 * subclasses a Curso class and can be used to display
 * a collection of Curso objects.
 *
...
class CursoListGen extends QDataGrid {
	/**
	...
	public function CreateColumns() {
		$this->colCursoId = $this->CreateNodeColumn("Curso Id", QQN::Curso()->CursoId);
		$this->colNombre = $this->CreateNodeColumn("Nombre", QQN::Curso()->Nombre);
		$this->colDescripcion = $this->CreateNodeColumn("Descripcion", QQN::Curso()->Descripcion);
		$this->colCreateby = $this->CreateNodeColumn("Createby", QQN::Curso()->Createby);
		$this->colCreated = $this->CreateNodeColumn("Created", QQN::Curso()->Created);
		$this->colUpdateby = $this->CreateNodeColumn("Updateby", QQN::Curso()->Updateby);
		$this->colUpdated = $this->CreateNodeColumn("Updated", QQN::Curso()->Updated);
		$this->colActive = $this->CreateNodeColumn("Active", QQN::Curso()->Active);
	}
	...
	**/
	public function BindData($objAdditionalCondition = null, $objAdditionalClauses = null) {
		...
		if ($this->Paginator) {
			$this->TotalItemCount = Curso::QueryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = Curso::QueryArray($objCondition, $objClauses);
	}
