 ...
 * subclasses a Nivel class and can be used to display
 * a collection of Nivel objects.
 *
...
class NivelListGen extends QDataGrid {
	/**
	...
	public function CreateColumns() {
		$this->colNivelId = $this->CreateNodeColumn("Nivel Id", QQN::Nivel()->NivelId);
		$this->colNivel = $this->CreateNodeColumn("Nivel", QQN::Nivel()->Nivel);
		$this->colCreateby = $this->CreateNodeColumn("Createby", QQN::Nivel()->Createby);
		$this->colCreated = $this->CreateNodeColumn("Created", QQN::Nivel()->Created);
		$this->colUpdateby = $this->CreateNodeColumn("Updateby", QQN::Nivel()->Updateby);
		$this->colUpdated = $this->CreateNodeColumn("Updated", QQN::Nivel()->Updated);
		$this->colActive = $this->CreateNodeColumn("Active", QQN::Nivel()->Active);
	}
	...
	**/
	public function BindData($objAdditionalCondition = null, $objAdditionalClauses = null) {
		...
		if ($this->Paginator) {
			$this->TotalItemCount = Nivel::QueryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = Nivel::QueryArray($objCondition, $objClauses);
	}
