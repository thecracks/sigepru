 ...
 * subclasses a Alumno class and can be used to display
 * a collection of Alumno objects.
 *
...
class AlumnoListGen extends QDataGrid {
	/**
	...
	public function CreateColumns() {
		$this->colAlumno = $this->CreateNodeColumn("Alumno", QQN::Alumno()->Alumno);
		$this->colCreateby = $this->CreateNodeColumn("Createby", QQN::Alumno()->Createby);
		$this->colCreated = $this->CreateNodeColumn("Created", QQN::Alumno()->Created);
		$this->colUpdateby = $this->CreateNodeColumn("Updateby", QQN::Alumno()->Updateby);
		$this->colUpdated = $this->CreateNodeColumn("Updated", QQN::Alumno()->Updated);
		$this->colActive = $this->CreateNodeColumn("Active", QQN::Alumno()->Active);
	}
	...
	**/
	public function BindData($objAdditionalCondition = null, $objAdditionalClauses = null) {
		...
		if ($this->Paginator) {
			$this->TotalItemCount = Alumno::QueryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = Alumno::QueryArray($objCondition, $objClauses);
	}
